...
<img width="1280" height="720" alt="scheme-like interpreter overview" src="https://github.com/user-attachments/assets/9595b605-39ed-4a64-9bb9-9a1090325129" />
...
- List operations including `car`, `cdr`, and `cons`
...
User Input → Scanner → Tokens → Parser → S-expression Tree → Evaluator → Result / Error
                                                           ↕
                                                      Environment
...
- Recursive parsing
- Tree-based S-expression representation
- Dynamic environment management
- Function parameter binding
- Recursive evaluation
- Exception and runtime error handling
